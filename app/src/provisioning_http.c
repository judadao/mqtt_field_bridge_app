...
"header .bar{max-width:1040px;margin:0 auto;padding:18px 20px}main{max-width:1040px;margin:0 auto;padding:18px 20px 28px}.hide{display:none!important}h1{margin:0;font-size:22px;font-weight:700}h2{font-size:14px;letter-spacing:0;text-transform:uppercase;color:var(--muted);margin:0 0 12px}.muted{color:var(--muted)}"
".bar{display:flex;gap:10px;align-items:center;justify-content:space-between;flex-wrap:wrap}.grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.panel{background:var(--panel);border:1px solid var(--line);border-radius:8px;padding:14px;margin-bottom:14px;box-shadow:0 1px 2px rgba(16,24,20,.04)}"
...
".tabs{display:flex;gap:6px;margin:0 0 14px;flex-wrap:wrap;background:var(--tab);border:1px solid var(--line);border-radius:8px;padding:4px}.tab{background:transparent;color:var(--muted);border-color:transparent}.tab.active{background:var(--panel);color:var(--fg);border-color:var(--line);box-shadow:0 1px 2px rgba(16,24,20,.05)}"
...
"pre{white-space:pre-wrap;margin:0;max-height:320px;overflow:auto;background:var(--panel2);border:1px solid var(--line);border-radius:8px;padding:10px}.small{font-size:12px}@media(max-width:760px){main{padding:14px}.grid,.peer{grid-template-columns:1fr}.actions{justify-content:flex-start}.tabs{display:grid;grid-template-columns:1fr}.tab{text-align:left}}"
