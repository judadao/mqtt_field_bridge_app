...
".pill{display:inline-block;border:1px solid var(--l);border-radius:99px;padding:4px 9px;color:var(--m)}.op{border:1px solid var(--l);border-radius:8px;background:var(--b);padding:10px 12px;font-weight:700;overflow-wrap:anywhere;text-align:center}.tab{background:transparent;color:var(--a)}.tab.on{background:var(--btn);color:white}.pop{position:fixed;inset:0;z-index:9;background:rgba(15,23,42,.4);display:grid;place-items:center;padding:18px}.modal{width:min(420px,100%);border:1px solid var(--l);border-radius:8px;background:var(--p);padding:14px;box-shadow:0 18px 50px rgba(15,23,42,.28);text-align:center}.hide{display:none}.ok{color:#2e7d32}.err{color:var(--d)}"
...
"<div id=pop class='pop hide'><div class=modal><h2>Operation Result</h2><div id=o class=op>Ready</div><p><button id=pop_ok onclick=closePop()>OK</button></p></div></div>"
